...
- **Contact**: `/contact` channel buttons (Email, WhatsApp, Through AI agent â bot gate + chat via `startChatAfterBotCheck` / `eduardoos:contact-start-agent`); `ContactAgent` also docks on home desktop
