...
export function IconPrevious({ className }: IconProps) {
    return (<svg className={className ?? iconClass} viewBox="0 0 24 24" aria-hidden="true">
...
export function IconLoop({ className }: IconProps) {
    return (<svg className={className ?? iconClass} viewBox="0 0 24 24" aria-hidden="true">
      <path d="M17 7h-4V3l-5 5 5 5V9h4a4 4 0 0 1 4 4 4 4 0 0 1-4 4H7v2h10a6 6 0 0 0 0-12zM7 17h4v4l5-5-5-5v4H7a4 4 0 0 1-4-4 4 4 0 0 1 4-4h2V5H7a6 6 0 0 0 0 12z" fill="currentColor"/>
    </svg>);
}
export function IconAddToPlaylist({ className }: IconProps) {
    return (<svg className={className ?? iconClass} viewBox="0 0 24 24" aria-hidden="true">
      <path d="M5 12h12m-6-6 6 6-6 6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>);
}
export function IconChevronUp({ className }: IconProps) {
    return (<svg className={className ?? iconClass} viewBox="0 0 24 24" aria-hidden="true">
      <path d="m6 14 6-6 6 6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>);
}
...
export function IconMixer({ className }: IconProps) {
    return (<svg className={className ?? iconClass} viewBox="0 0 24 24" aria-hidden="true">
      <path d="M4 10v4M8 6v12M12 4v16M16 8v8M20 10v4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    </svg>);
}
