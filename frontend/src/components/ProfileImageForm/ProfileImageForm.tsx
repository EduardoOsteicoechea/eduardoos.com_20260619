...
export default function ProfileImageForm() {
    ...
    return (<form className="profile-image-form panel" onSubmit={(event) => void handleSubmit(event)}>
      ...
      <div className="profile-image-form__preview-wrap">
        {imageUrl ? (<img className="profile-image-form__preview" src={imageUrl} alt="Profile preview"/>) : (<div className="profile-image-form__preview profile-image-form__preview--empty" aria-hidden="true">
            ?
          </div>)}
      </div>
      ...
      <div className="form-field">
        ...
        <input id="profile-file" name="profile-file" type="file" accept="image/png,image/jpeg,image/webp,image/gif" onChange={handlePreviewChange}/>
      </div>
