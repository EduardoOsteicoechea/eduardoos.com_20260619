import { buildEmptyPamphletV3Document, recalculateItemHeights, PAMPHLET_V3_COLUMN_WIDTH_MM, PAMPHLET_V3_HEADER_FOOTER_WIDTH_MM, type PamphletV3ContentItem, type PamphletV3Document, type PamphletV3ItemType, } from "../components/PamphletV3/pamphletV3Content";
import { isAuthenticated } from "./auth";
import { ACTIVE_PAMPHLET_ID_KEY, persistActivePamphletId, readStoredPamphletId, } from "./pamphletPersistence";
import { DEFAULT_LAYOUT, fetchPamphletDocumentById, fetchPamphletRegistry, savePamphletBundleToCloud, type PamphletDocument, type SavePamphletBundleResponse, } from "./pamphlets";
...
export async function savePamphletV3Bundle(options: {
    ...
    const response = await savePamphletBundleToCloud(options.pamphletId, title, pamphletV3DocumentToDb(options.document), {
        ...DEFAULT_LAYOUT,
