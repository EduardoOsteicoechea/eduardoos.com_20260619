/**
 * subscriptions.ts — Subscription catalog, pricing, and entitlement API helpers.
 */
...
export type SubscriptionServiceId =
  (typeof SUBSCRIPTION_SERVICES)[number]["id"];
...
/** Calculates the checkout total for the selected services. */
...
/** Creates a payment intent for the selected services and billing period. */
